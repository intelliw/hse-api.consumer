...
class BqProducer {
    ...
    */
    constructor(dataset, table) {
        ...
        this.bqClient = new BigQuery();                                     // $env:GOOGLE_APPLICATION_CREDENTIALS="C:\_frg\_proj\190905-hsy-api-consumer\credentials\sundaya-d75625d5dda7.json"
    ...
    async insertRows(sharedId, rowArray) {
        ...
        // [start trace] -------------------------------
        const sp = log.TRACE.createChildSpan({ name: `${log.enums.methods.bqInsertRows}` });
