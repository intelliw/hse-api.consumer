...
class MonitoringProducer extends Producer {
    ...
    */
    constructor(writeTopic, datasetParam, bqDataset, bqTable) {

        // create the storage object
        let storage = new BqStorage(bqDataset, bqTable);                // $env:GOOGLE_APPLICATION_CREDENTIALS="C:\_frg\_proj\190905-hsy-api-consumer\credentials\sundaya-d75625d5dda7.json"      
    ...
    */
    async produce(transformedMsgObj) {
        ...
        try {
            ...
            sharedId = rowArray[0][`${this.datasetParam}_id`];                         // if is common to all rows and is used only for logging. e.g. rowArray.pms_id. If the JSON element name is not based on the table name this line must be modified
