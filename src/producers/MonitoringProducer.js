    ...
    async produce(transformedMsgObj) {
        ...
        try {
            ...
            transformedMsgObj.messages.forEach(message => {
                ...
                id = rowArray[FIRST_AND_ONLY_ROW][`${this.storage.table}_id`];          // e.g. rowArray.pms_id. If the JSON element name is not based on the table name this line must be modified
